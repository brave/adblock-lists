...
If modify, follow [these instructions](https://github.com/brave/brave-browser/wiki/Debouncing#testing-new-rules) to test your changes locally. Substitute `debounce.json` with `clean-urls.json`
